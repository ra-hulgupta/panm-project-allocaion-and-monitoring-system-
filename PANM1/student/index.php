...
?>
    ...
    <section class="container-fluid header-section link-shadowed">

    <div class="student_data1">        
        <h3 style="font-family: 'times new roman';font-size: 23px;" align="right">Id: <?php echo $_SESSION['student_id']; ?>  &emsp;   Name : <?php echo $_SESSION['student_name']; ?>&emsp; <a href="./student_logout.php">Logout</a>&emsp;</h3>
        <small class="msg">
        <?php
                            if(isset($_GET['msg']))
                                echo $_GET['msg'];
