...
//    print_r($r);
    ...
    if (isset($_POST['insert'])) {
        ...
        $avg = $sum / $count;
        $sql = 'insert into groups (leader,mem1,mem2,mem3,average,project,PID1,PID2,PID3) values (' . $_SESSION['student_id'] . ',' . $member1 . ',' . $member2 . ',' . $member3 . ',' . $avg . ',0,'.$pid1.','.$pid2.','.$pid3.')';
        $dbhandler->query($sql);
        ...
        $sql = 'update groups SET mem1=' . $member1 . ',mem2=' . $member2 . ',mem3=' . $member3 . ',average=' . $avg . ' ,PID1 ='.$pid1.', PID2='.$pid2.',PID3='.$pid3.' where leader=' . $_SESSION['student_id'];
        $dbhandler->query($sql);
    ...
    echo 'problem occured try later'.$ex;
}
?>
