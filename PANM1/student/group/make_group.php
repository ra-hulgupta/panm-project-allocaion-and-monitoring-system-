...
<html>
    ...
    <body>
		...
		<h3 align="left"><a href="work_assign.php" class="back shadow">Work Assign</a></h3>
...
try {
    ...
    if ($r == NULL) {
        echo '<input type="hidden" name="insert" value="1">
							...
							<tr>
                                <td>Project Id 1</td>
                                <td><input type="text" class="textbox" name="PID1"></td>
                            </tr>
							<tr>
                                <td>Project Id 2</td>
                                <td><input type="text" class="textbox" name="PID2"></td>
                            </tr>
                            <tr>
                                <td>Project Id 3</td>
                                <td><input type="text" class="textbox" name="PID3"></td>
                            </tr>';
    } else {
        if ($r['mem1'] == 0) {
            echo '<tr>
