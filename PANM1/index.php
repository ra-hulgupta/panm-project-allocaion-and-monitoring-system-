...
<form class="form-horizontal myform" action="./data.php" method="POST">
    <div class="form-group">
      <label class="control-label col-xs-3" for="student_id" style="color:dodgerblue;font-weight:bold;">Student Id</label>
      <div class="col-xs-9">
    ...
    <div class="form-group">
      <label class="control-label col-xs-3" for="student_passwd" style="color:dodgerblue;font-weight:bold;">Password:</label>
      <div class="col-xs-9">          
